...
export default observer(function ProfilePhotos({ profile }: Props) {
    ...
    function handleDeletePhotophoto(photo: Photo, e: SyntheticEvent<HTMLButtonElement>) {
        setTarget(e.currentTarget.name);
        deletePhoto(photo);
    }
                                ...
                                {isCurrentUser && (
                                    <ButtonGroup fluid widths={2}>
                                        <Button
                                            ...
                                            loading={loading && 'main' + target === photo.id}
                                            onClick={(e) => handleSetMainPhoto(photo, e)}
                                        />
                                        <Button
                                            onClick={(e) => handleDeletePhotophoto(photo, e)}
                                            basic color="red"
                                            icon='trash'
